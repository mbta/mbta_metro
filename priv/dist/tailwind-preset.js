(() => {
  ...
  var import_plugin, buttonPlugin, button_default;
  var init_button = __esm({
    "js/plugins/button.js"() {
      import_plugin = __toESM(require_plugin());
      buttonPlugin = (0, import_plugin.default)(({ addBase, addComponents, theme }) => {
        addBase({
          "button.mbta-button": {
            alignItems: "center",
  ...
  var init_plugins = __esm({
    "js/styles/plugins.js"() {
      init_button();
      plugins_default = [button_default];
    }
  });
  ...
  var require_tailwind_preset = __commonJS({
    "js/tailwind-preset.js"(exports, module) {
      ...
      var metroTheme = require_tokens();
      var theme = deepMerge(defaultTheme, metroTheme);
