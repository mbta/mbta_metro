(() => {
  ...
  // ../priv/design-system/tokens.base.js
  var require_tokens_base = __commonJS({
    "../priv/design-system/tokens.base.js"(exports, module) {
      module.exports = {
        theme: {
          colors: {
            charcoal: {
  ...
  var require_default_theme = __commonJS({
    "node_modules/tailwindcss/dist/default-theme.js"(exports, module) {
      "use strict";
      var m = new Uint8Array(256);
      function d(e, c) {
        let t = 0, g = [], u = 0, k = e.length, w = c.charCodeAt(0);
        for (let n = 0; n < k; n++) {
          let h = e.charCodeAt(n);
          if (t === 0 && h === w) {
            g.push(e.slice(u, n)), u = n + 1;
            continue;
          }
          switch (h) {
            case 92:
  ...
  var require_colors = __commonJS({
    "node_modules/tailwindcss/dist/colors.js"(exports, module) {
      "use strict";
  ...
  var require_tailwind_preset = __commonJS({
    "js/tailwind-preset.js"(exports, module) {
      var { theme } = require_tokens_base();
      module.exports = {
        content: [
